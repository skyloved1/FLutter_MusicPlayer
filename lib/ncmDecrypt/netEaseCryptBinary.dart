...
class NeteaseCrypt {
  ...
  int? get decryptedDataLength => decryptedData?.length;
  Uint8List? get decryptedDataData => decryptedData;
  ...
  NeteaseCrypt(this.filepath) : file = File(filepath) {
    ...
    if (n <= 0) {
      ...
      // Store decrypted data as Uint8List
      decryptedData =
          Uint8List.fromList(utf8.encode(modifyDecryptData.toString()));
    }
